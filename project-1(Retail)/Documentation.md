...
* Made use of the IF and RIGHT function in Google Sheets to concatenate the numbers in "CustomerID" and compare it with the Transaction ID to eliminate any typographical errors. Click [this](references/before.PNG) for the before data cleaning reference and [this](references/after_datacleaning.PNG) for the after data cleaning reference.
