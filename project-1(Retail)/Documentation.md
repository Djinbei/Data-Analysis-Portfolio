...
**Results, Conclusion, and Recommendations**
   ...
   The retail company made 456,000 dollars in overall revenue, with an average of 456 dollars per transaction which can either be favorable or not based on the retail company's target goals, size and scale, benchmarks (Was sales from the last year higher or lower compared to now?), profitability, timeframe, and external factors. Peak sales was observed on the month of May while the lowest was observed on September. Consistent high sales volume was evident in Q4 (October, November, December) making it the company's strongest sales period while Q3 (July, August, September) is considered to be the weakest. The highest performing product category in terms of sales contribution is Electronics, slightly outperforming Clothing, and significantly exceeding Beauty sales. This performance may be attributed to stronger promotions and greater in-store and online visibility for Electronic and Clothing products compared to Beauty products. Female customers contributed slightly more sales than Males, which means that the company's feminine product lines has a slightly better pull than masculine products which could be an improvement opportunity. Furthermore, for this year, the company pulls in a large amount of adult customers and slight amount of young adult customers possibly due to offering a variety of products that are essential and useful to Adults and Young Adults. However, the company does not resonate with Children or Seniors possibly due to the products' exclusivity to Adults and Young adults. It can also be explained by children's lack of purchasing power and seniors minimal inclination towards material products.

   Furthermore, the data also shows that Adults have higher preference for Clothing, while Youth leans more towards Beauty products, possibly due to Adults' need for professional clothes at work or clothes that resonate with other adults in social settings. On the other hand, young adults tend to tie self worth to public image so it is realistic that they prefer beauty products over anything else. Segmenting by gender, the data reveals females' stronger preference for Clothing products compared to Males greater inclination for Electronics. This is supported by multiple researches on female consumers' product preference where they found that females prefer appearance-related products to boost their self-esteem and promote self-expression in social or work settings, while male consumers have a stronger interest towards building things from scratch using technology or technological tools. Beauty has the highest average price per unit followed by Electronics, then Clothing. Considering that Beauty has the lowest sales contribution, a need to lower its average price per unit or promote its appeal to customers are essential for company profit growth.

   2,514 units were sold for the whole year, with an average of 2.51 units sold per transaction. Company should therefore expect 2,500 to 3,000 units in demand for the next year. Monthly units sold garnered equal levels for Q1 (January, March, April), with a trend of highs and lows observed during Q3 and Q4 (August, September, October) with the peak month determined to be May and lowest units sold volume to be September. Monthly units supply will be for the first quarter, followed with incosistencies for the following months specially in the third and fourth quarter of the year. Supply fluctuations should be expected starting from May up until December, and expect high supply requests during May and low supply requests for September.  Clothing products generated the most amount of units sold during March up until May, with Electronic products having its lowest unit sold during March, slowly rising and recovering during June. There were no observed monthly units sold trends or patterns for Beauty products except for relatively low baseline. Therefore, we can be confident that our highest performer is indeed Electronic products, followed by Clothing products, with Beauty producs as the lowest performing product line.

Considering all of the insights derived from the data, I give recommendations to improve the company's marketing strategy, facility layout, and resource allocation. 

**Marketing Strategies**: The company should consider product bundles (e.g. X amount of discount for beauty products if consumer buys 1 or 2 electronics worth XXX amount, lowering combined price point), free beauty products scamples, time-limited discounts after free sampling, introduce on-trend beauty products to attract Children into asking their parents to buy the products for them. Placing many beauty products on the recommended products section of the company's website will increase its visibility, increasing its market appeal. To also attract seniors, the company can create a collection of products (Electronics, Clothing, and Beauty) that caters to their specific needs and promote them traditionally (flyers, newspaper advertisements, etc.) The company should make sure to do these promotions during high performing months or periods or leveraging seasonal campaings (Black Friday, St. Patrick's Day, Valentine's Day, etc.) to maximize their reach. Collaboration with current and past public figures can exponentially increase company exposure to any kinds of customers (Children, Adults, Young Adults, and even Seniors), making it a wise investment for the long term growth of the company. Lastly, The company should look into strong performing months and periods and evaluate the strategies used during that specific month (discounts, holiday sales, campaigns) and see if they can also be applied during dry months or periods. 
  
**Resource Allocation**: The company should expend less resources on marketing strategies and prmotions during high performing periods and using them to improve other aspects of the company such as company operations, logistics, inventory management, supply chain management, and each outlets layout design if the company has multiple branches. This prevents bottlenecks across departments and lets the company continue its operations for a long time.  

**Facilities Layout and Design**: I also recommend some changes in each retail outlets' design. Place beauty products near the entrance to increase its visibility and accessibility to customers. Hire an Industrial Engineer to make a facility design that makes each product categories stand out while putting a large emphasis on aesthetic and effective space allocation. Integrate clear and understandable visual signages to properly guide customers to the product aisles. Consider dividing the outlet stores into male and female sections, and partitioning each division into Children, Young Adult, Adults, and Senior sections to reduce confusion --- This can only be applied to Clothing and Beauty products.

**Inventory Management**: The company should keep 250-300 units ready in stock every month to prevent stockouts and ready safety buffers in case of unexpected high demands. Take note of peak sales period and adjust stored inventory as necessary. 300 units gives a 5% buffer, the company could increase this percentage as they see fit.

Taking the necessary steps to implement these recommendations can hypothetically increase company profit by 3-5 percent.
